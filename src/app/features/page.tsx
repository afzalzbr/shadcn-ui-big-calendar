    ...
    <main className="mx-auto my-auto w-full max-w-7xl space-y-8 px-4 sm:px-6 lg:px-8 sm:pb-8">
      <header className="max-w-3xl space-y-4">
        ...
        <p className="text-lg text-muted-foreground">
          Explore the powerful features of Shadcn Big Calendar through
          interactive demos. Each example includes working code, detailed
          explanations, and implementation guidance.
        </p>
      </header>

      <section className="space-y-4">
        <div className="mx-auto my-auto w-full max-w-7xl space-y-8">
      ...
      <section className="space-y-4">
        ...
        <p className="text-muted-foreground">
          Each feature demo includes complete, working code examples that you
          can copy and integrate into your own projects. The examples use
          TypeScript for type safety and follow React best practices with proper
          hooks usage and memoization.
        </p>
