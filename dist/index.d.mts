...
declare function ShadcnBigCalendar<TEvent extends object = object, TResource extends object = object>({ height, style, ...props }: ShadcnBigCalendarProps<TEvent, TResource>): react_jsx_runtime.JSX.Element;
